...
from . import api_v2, audit_views, builder_api, booking_lifecycle_views, frontend_compat, provider_views, logic_views, marketplace_views
...
urlpatterns = [
    ...
    path("bookings/<uuid:booking_id>/", booking_lifecycle_views.booking_detail_api),
